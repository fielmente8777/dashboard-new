        ...
        <div className='max-w-[1600px] mx-auto bg-[#f5f5f5] w-full h-[100vh] grid grid-cols-1 lg:grid-cols-2'>
            <div className='h-screen bg-white overflow-hidden'>
                ...
                <div className='flex justify-center items-center h-[94vh]'>
                    ...
                    <form className=' md:w-[25rem] p-5 rounded-md' onSubmit={handleSubmit}>
                        <h1 className='text-2xl font-bold'>Welcome back</h1>
                        <p className='text-[14px] font- text-[#575757]/70 mt-2'>Please enter your details</p>
                        <div className="flex flex-col flex-1 gap-5 w-full h-full mt-5">


                            <div className="flex flex-col gap-1 ">
                                <label htmlFor="username" className="text-black font-medium !text-[14px]">
                                    Email address
                                </label>
                                <input
                                    type="text"
                                    ...
                                    className={` ${error === "email" ? "border border-red-600 text-red-600 animate-pulse" : "border text-black/70"}   px-3 rounded-lg focus:outline-none  outline-none text-[14px] py-2`}
                                />

                            </div>
                            {/* {!error && <p className="error-message text-[#0a3a75]">{error ? error : "This is the error field"}</p>} */}
                            <div className="flex flex-col gap-1 relative">
                                <label htmlFor="password" className="text-black font-medium text-[14px]">
                                    Password
                                </label>
                                <input
                                    ...
                                    // required
                                    onChange={handleChange}
                                    className={` ${error === "password" ? "border border-red-600 text-red-600 animate-pulse" : "border text-black/70"}   px-3 rounded-lg focus:outline-none  outline-none text-[14px] py-2`}
                                />
                            ...
                            <p className='text-[14px] text-center'>Dont have an account? {" "}<Link to="/https://www.eazotel.com" target='_blank' className='text-[#0a3a75]'>Sign up</Link></p>
                        </div>
