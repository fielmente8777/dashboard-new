            ...
            <div className="max-w-6xl mx-auto py-10 space-y-8">
                ...
                <section className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                    <InfoCard
                        ...
                        label="Start date"
                        value={new Date(subscription?.startDate).toLocaleDateString("en-IN", {
                            day: "2-digit",
                            month: "short",
                            year: "numeric",
                        })}
                ...
                <section className="">
                    <div className="flex items-start gap-3 mb-5">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-muted-foreground">Latest billing references</p>
                        </div>
                    </div>
...
function InfoCard({
    ...
    return (
        <div className="rounded-2xl border border-border bg-card p-5  hover:-translate-y-0.5 ">
            <div
                className={`inline-flex h-9 w-9 items-center justify-center rounded-lg ${highlight
            ...
            <p
                className={`mt-1 text-md font-medium text-gray-900 ${capitalize ? "capitalize" : ""
                    }`}
            >
                {value}
            </p>
