...
const GSTFiling = () => {
  return (
    <div className="p-4 bg-white mb-10 cardShadow">
      <CommanHeader serviceName={"GST Filing"} />

      <hr className="mt-3" />
      <p className="mb-4 text-gray-600 mt-2">
        Our GST Filing service ensures that your property business stays fully
        compliant with all government tax regulations. From accurate invoicing
        to timely return submissions, we take the hassle out of your monthly and
        quarterly GST responsibilities.
      </p>
      ...
      <p className="mt-6 text-gray-600">
        Whether you're a small homestay or a multi-property hotel brand, our GST
        experts ensure your filings are always accurate and on time — giving you
        peace of mind and a clear tax trail.
      </p>
    </div>
  );
};
