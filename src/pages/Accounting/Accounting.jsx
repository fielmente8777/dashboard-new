...
const Accounting = () => {
  return (
    <div className="p-4 bg-white mb-10 cardShadow">
      <CommanHeader serviceName={"Accounting"} />

      <hr className="mt-3" />
      <p className="mb-4 text-gray-600 mt-2">
        Our comprehensive Accounting service is designed specifically for
        hospitality businesses. We manage your financial records, cash flows,
        revenue tracking, and cost allocations to ensure your property stays
        profitable and compliant with financial best practices.
      </p>
      ...
      <p className="mt-6 text-gray-600">
        Let our accounting team handle the numbers so you can focus on
        delivering a great guest experience. Our reports and dashboards are easy
        to understand and tailored for hotel and homestay operations.
      </p>
    </div>
  );
};
