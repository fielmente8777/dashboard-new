        ...
        <div className="w-80 bg-white border-l border-gray-200 flex flex-col">
            ...
            <div className="p-6 border-b border-gray-200">
                <div className="flex items-center mb-4">
                    ...
                    <div>
                        <h3 className="text-lg font-semibold text-gray-900">{selectedContact}</h3>
            ...
            <div className="flex-1 overflow-y-auto">
                    ...
                    {expandedSections.payments && (
                        <div className="px-4 pb-4">
                            <div className="bg-gray-50 rounded-lg p-3">
                                ...
                                <p className="text-xs text-gray-400 text-center py-4">No payment records</p>
                            </div>
                        </div>
                    )}
                </div>
                ...
                <div className="border-b border-gray-200">
                    ...
                    {expandedSections.campaigns && (
                        <div className="px-4 pb-4">
                            <p className="text-xs text-gray-400 text-center py-4">No campaigns</p>
                        </div>
                    )}
                </div>
                ...
                <div className="border-b border-gray-200">
                    ...
                    {expandedSections.attributes && (
                        <div className="px-4 pb-4">
                            <p className="text-xs text-gray-400 text-center py-4">No attributes</p>
                        </div>
                    )}
                </div>
