        ...
        <div className="flex-1 flex flex-col bg-gray-50">
            ...
            <div className="bg-teal-600 text-white px-6 py-4">
                <div className="flex items-center justify-between">
                    <h2 className="text-lg font-semibold">{selectedContact} (+919328405012)</h2>
                    <button className="text-teal-100 hover:text-white text-sm">Chat Profile</button>
                </div>
            </div>
            ...
            <div className="flex-1 p-6 overflow-y-auto">
                <div className="flex justify-center mb-4">
                    <span className="text-xs text-gray-500 bg-white px-3 py-1 rounded-full">22/07/2025</span>
                </div>
                ...
                {[1, 2, 3, 4, 5].map((item) => (
                    <div key={item} className="flex items-start mb-6">
                        ...
                        <div className="bg-teal-600 rounded-2xl rounded-tl-sm p-4 max-w-sm text-white">
                            ...
                            <p className="text-sm font-medium mb-2">Looking for your next goa ge...</p>
                            <p className="text-xs text-teal-100 mb-2">Escape to Nature. Indulge in Lu...</p>
                            <p className="text-xs text-teal-100 mb-2">fb.me</p>
                            <p className="text-xs text-teal-100 mb-3">Ad ID: 120225047748280256</p>
