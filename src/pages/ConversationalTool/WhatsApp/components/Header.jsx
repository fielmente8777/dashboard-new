                ...
                <div className="flex items-center gap-4">
                    {users.map((user, index) => (
                        <div key={index} className="relative">
                            <div className={`w-8 h-8 ${user.color} rounded-full flex items-center justify-center text-white text-xs font-medium cursor-pointer hover:scale-105 transition-transform`}>
