                  ...
                  {subscription?.appAccess &&
                    ...
                    !subscription?.appAccess[mappedId] && (
                      <div className="bg-white/80 text-white absolute top-0 left-0 w-full h-full flex justify-center items-center z-50">
                        <Link
                          to="/plans"
                          className="px-4 py-2 bg-primary shadow-md rounded-lg text-sm flex items-center gap-2"
                        >
              ...
              <>
                ...
                <button
                  ...
                  style={{
                    width: "100%",
                    padding: "12px",
                    background: selectedGmbLocation ? "#16a34a" : "#ccc",
                    color: "white",
                    border: "none",
                    borderRadius: "8px",
                    fontSize: "15px",
                    fontWeight: 600,
                    cursor: selectedGmbLocation ? "pointer" : "not-allowed",
                  }}
                >
                  Save & Connect
                </button>
