...
const LeadAnalytics = () => {
    ...
    const statusDistribution = [
        { name: "Open", value: enquires.filter(enquiry => enquiry.status === "Open").length },
        { name: "Converted", value: enquires.filter(enquiry => enquiry.status === "Converted").length },
        { name: "Contacted", value: enquires.filter(enquiry => enquiry.status === "Contacted").length },
    ];
                ...
                !loading ?
                    ...
                    <div className="grid md:grid-cols-3 lg:grid-cols-5 gap-4 mb-8 mt-4">
                        {[1, 2, 3, 4, 5].map((data) => (
                            ...
                            <div key={data.label} className="bg-zinc-100 h-[10rem] animate-pulse text-[#575757] px-4 pt-10 pb-12 rounded-md  text-center">
