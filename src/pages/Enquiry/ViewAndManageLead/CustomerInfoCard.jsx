...
const friendlyLabels = {
  ...
  return (
  <div className="flex flex-col bg-app-surface rounded-lg md:shadow-sm dark:shadow-[0_4px_12px_rgba(0,0,0,0.35)] p-5 h-auto border border-gray-200 dark:border-[#2d3748]">
