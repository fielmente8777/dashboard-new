        ...
        <div className="px-6 py-5 space-y-6">
          ...
          <div>
            ...
            <div className="grid grid-cols-4 gap-3">
              <div>
                <label className="text-xs text-gray-500 dark:text-app-text-muted mb-1 block">Check-in</label>
              ...
              <div>
                <label className="text-xs text-gray-500 dark:text-app-text-muted mb-1 block">Check-out</label>
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <div>
                <label className="text-xs text-gray-500 dark:text-app-text-muted mb-1 block">Meal Plan</label>
