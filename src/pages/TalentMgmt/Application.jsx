  ...
  return (
    <div className="bg-white cardShadow mb-10">
      <div className="flex mt-4">
        ...
        <div
          onClick={() =>
            dispatch(fetchApplicants(localStorage.getItem("token")))
          }
            ...
            <tbody>
              {applicants?.map((applicant, index) => (
                <tr key={index} className="border-b">
                  ...
                  <td className="py-3 text-[14px] text-[#575757] capitalize">
                    {applicant?.contact}
                  </td>
                  <td className="py-3 text-[14px]  text-blue-600">
                    <Link to={applicant?.resume_url} target="_blank">
                      {applicant?.resume_url.slice(0, 33)}...
                    </Link>
                  </td>
