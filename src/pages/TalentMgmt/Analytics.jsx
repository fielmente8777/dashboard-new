        ...
        <div className="p-4 bg-white">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="bg-white rounded-md">
                    <h3 className="text-[#575757] font-medium text-[14px] mb-2">Job Role Distribution</h3>
                ...
                <div className="bg-white rounded-md">
                    <h3 className="text-[#575757] text-[14px] mb-2 font-medium">Application Status Breakdown</h3>
                    <ResponsiveContainer width="100%" height={250}>
                        <PieChart>
                            <Pie data={applications} dataKey="count" nameKey="name" outerRadius={80} label>
