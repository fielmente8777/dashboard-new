...
const ReservationDesk = () => {
    ...
    const fetchBookingsData = async () => {
        ...
        const response = await getBookingsData(handleLocalStorage("token"), handleLocalStorage("hid"));
            ...
            <div>
                ...
                >
                    ...
                    >
                        ...
                        <span>
                            {bookingData != null ? bookingData.Details.length : 0}
                        </span>
                    </div>
                </div> */}
                <table className="w-full text-left bg-[#0a3a75] text-white/90 shadow-md rounded-sm  shadow-black/20">
                    ...
                    <tbody>
                        {bookingData?.map((row, rowIndex) => (
                            <tr key={rowIndex} className='py-1  border-b odd:bg-gray-50 even:bg-gray-100 rounded-lg border-gray-200 hover:bg-[#f8f8fb] transition duration-300 cursor-pointer'>
                                <td
                                ...
                                <td className='py-3 px-4 text-[14px]  text-[#575757]'>{row?.guestInfo?.EmailId} </td>
                                <td className='py-3 px-4 text-[14px]  text-[#575757]'>{row?.guestInfo?.Phone}</td>

                                <td className='py-3 px-4 text-[14px]  text-[#575757]'>{formatDateTime(row?.checkIn)}</td>
                                <td className='py-3 px-4 text-[14px]  text-[#575757]'>{formatDateTime(row?.checkOut)}</td>

                                <td className='py-3 px-4 text-[14px]  text-[#575757]'>{row?.price?.Total} </td>
                                ...
                                <td className='py-3 px-4 text-[14px]  text-[#575757]' style={{ cursor: "pointer" }}>
                                    {row?.payment?.Status === "CANCELLED" ? (
                                        "-"
