...
import { getAllVisitorsActivities } from "../../services/api/WebsiteTracker.api";
            ...
            {loading ? (
              ...
              sessions.map((session) => (
                ...
                >
                  ...
                  <td className="px-6 py-3">
                    {session?.session_end ? (
                      <p className="bg-red-300 rounded-md text-center">
                        Visited
                      </p>
                    ) : (
                      <p className="bg-green-300 rounded-md text-center">
                        Active
                      </p>
                    )}
                  </td>
                  ...
                  {/* <td>
                    {session?.pages?.map((page, index) => (
                      <div key={index}>
                        <p>
                          Page: {page?.url}, Time Spent: {page?.duration}
                        </p>
                      </div>
                    ))}
                  </td> */}
