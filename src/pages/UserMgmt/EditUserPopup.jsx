...
const EditUserPopup = ({ editData, setEditUserData, isEditPopupOpen, onClose, fetchData }) => {
    const roles = [
        "CMS",
        "Social Media",
        "Frontdesk",
    ...
    return (
        <div
            className={`fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 transition-opacity ${isEditPopupOpen ? "opacity-100 visible" : "opacity-0 invisible"
                }`}
        >
