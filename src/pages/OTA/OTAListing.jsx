  ...
  return (
    <div className="p-4 bg-white mb-10 cardShadow">
      ...
      <p className="mb-4 text-gray-600 mt-2">
        Our OTA (Online Travel Agency) Listing service helps you get your
        property listed across top booking platforms to maximize your visibility
        and boost occupancy. We ensure your property stands out with
        well-crafted profiles and optimized content.
      </p>
      ...
      <h2 className="text-md font-semibold text-gray-600 mt-6 mb-2">
        What’s Included:
      </h2>
      <ul className="list-disc pl-6 text-gray-600 space-y-1">
      ...
      <p className="mt-6 text-gray-700">
        We handle the end-to-end onboarding process for each platform and ensure
        your listings are updated and competitive. Our team also assists with
        resolving OTA-related issues and optimizing your rankings regularly.
      </p>
