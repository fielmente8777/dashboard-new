...
import { DeleteImage, GetwebsiteDetails } from '../../services/api';
                    ...
                    <div className='grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-3 gap-4 mt-5'>
                        {websiteoffersdata[0]?.image && websiteoffersdata?.map((item, index) => (
                            <div key={index} className={`flex flex-col relative gap-2 ${activeIndex === index ? "bg-white z-10" : ""}`} onMouseEnter={() => setActiveIndex(true)} onMouseLeave={() => setActiveIndex(false)}>
                                ...
                                />
                                <div>
                                    <h2 className="text-sm font-semibold text-[#575757] ">{item.name}</h2>
                                    <p className='text-[#575757]/80'>{item.description}</p>
                                    <p className="text-sm text-[#575757]/80 font-semibold uppercase">{item.valid}</p>
                                    <div className='mt-1'>
                                        <h3 className="font-semibold text-[#575757] text-sm">Includes:</h3>
                                    ...
                                    <div className='mt-1'>
                                        <h3 className="font-semibold text-[#575757] text-sm">Need to Know:</h3>
