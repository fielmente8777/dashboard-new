...
const Events = () => {
    ...
    return (
        <div className='bg-white  p-4'>
...

                {
                    loading ?
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
                            {websiteEventsData[0]?.Image && websiteEventsData?.map((item, index) => (
                                <div key={index} className="bg-white rounded-lg p-4 mb-4 relative">
                                    <div>
                                        ...
                                        <img src={item?.Image} alt={item?.title} className="w-full h-[60vh] object-cover mb-4" />

                                    </div>
                                    <div>
                                        <h3 className="text-sm font-semibold text-[#575757] mb-2">{item?.Heading}</h3>
                                        <p className="text-sm text-[#575757]/70 mb-2 ">{item?.Text}</p>
                                        <p className="text-sm text-[#575757] font-semibold">{item?.date}</p>
                            ...
                            {addEventLoader && <div className='h-[75dvh] animate-pulse bg-gray-100 mt-4' />}
                        </div>
                }
            ...
            <form onSubmit={handleSubmit} className='grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-4 gap-4 mt-2'>
                ...
                <button type='submit' className='bg-[#0a3a75] text-white px-4 py-2 rounded-md'>Add</button>
            </form>
        </div>
    )
}
