    ...
    return (
        <div className='bg-white p-4'>
            <div className='flex  justify-between items-center '>
                ...
                <button className='font-semibold  bg-[#0a3a75] hover:bg-[#0a3a75]/90 text-white px-3 py-1 flex items-center rounded-sm text-[14px]' onClick={() => { update(text) }}>Update</button>
            </div>
