          ...
          <div className="">
            <div>
              <h2 className="text-xl font-medium">
                {" "}
                Please selete any service!
              </h2>
            </div>
            <div className="flex gap-2 whitespace-nowrap flex-wrap py-5">
              {selectedServices.length > 0 ? (
                selectedServices.map((item) => (
                  <button className="bg-gray-200 px-3 font-medium py-1 tracking-wide rounded-full text-[12px] text-gray-700">
                    {item}
                  </button>
                ))
              ) : (
                <p className="bg-gray-200 px-3 font-medium py-1 tracking-wide rounded-full text-[12px] text-gray-700">
                  No service selected
                </p>
              )}
            </div>
