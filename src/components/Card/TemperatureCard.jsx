...
`}> */}
            ...
            <video
                src={
                    weatherCondition === "Rainy" ? RainVideo : weatherCondition === "Cloudy" ? CouldVideo : weatherCondition === "Sunny" ? SummerVideo : ""}
                autoPlay
                loop
                muted
                playsInline
                ...
                <div className='flex flex-col justify-between h-full py-6'>
                    ...
                    <div className="flex items-center justify-between">
                        <div className="flex items-center space-x-2 ">
                            <Cloud />
                            <span className="text-7xl font-semibold  !text-white ">{weatherData?.current?.temp_c}°</span>
                        </div>
                        <div className="text-right">
                            <div className="text-md font-semibold !text-white ">{getDay("day")}</div>
                            <div className="text-sm !text-white ">{getDay("date")}, {weatherData?.location?.name}</div>
                            <div className="text-sm !text-white ">{weatherData?.location?.country}</div>
                        </div>
                    </div>
