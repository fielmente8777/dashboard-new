      ...
      >
        ...
        <div className="relative flex items-center justify-between px-6 pt-6 pb-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-sm font-bold tracking-tight text-white">Credits</h2>
              <p className="text-[11px] text-zinc-200">Balance & usage history</p>
            </div>
          </div>
          <button
            onClick={onClose}
            className="rounded-xl p-2 text-zinc-200 transition hover:bg-white/[0.06] hover:text-zinc-300"
          >
            <X className="h-4 w-4" />
          </button>
        </div>
        ...
        <div className="relative mx-5 mb-5 overflow-hidden rounded-2xl border border-white/[0.07]
          ...
          <div className="flex items-center justify-between gap-4">
            {/* Left: number */}
            <div>
              <p className="text-[11px] font-semibold uppercase tracking-widest text-zinc-200">
                Available
              </p>
        ...
        <div className="relative flex-1 overflow-y-auto px-5 pb-6 space-y-6
          ...
          {/* Credit costs */}
          <div>
            <p className="mb-3 text-[10px] font-bold uppercase tracking-widest text-zinc-200">
              Credits per action
            </p>
              ...
              {CREDIT_ACTIONS(pricing).map(({ icon: Icon, label, sublabel, cost, gradient, ring, iconBg, badge }) => (
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-[10px] text-zinc-2s00 leading-tight mt-0.5">{sublabel}</p>
                  </div>
            ...
            <p className="mt-2.5 text-[10px] text-zinc-200">
          ...
          <div>
            ...
            {loading ? (
              ...
              <div className="flex flex-col items-center gap-2 rounded-2xl border border-dashed
                ...
                <p className="text-xs text-zinc-200">Usage appears here after your first scan.</p>
              </div>
            ) : (
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="min-w-0 flex-1">
                        ...
                        <p className="text-[10px] text-zinc-100">{formatDate(tx.createdAt)}</p>
                      </div>
